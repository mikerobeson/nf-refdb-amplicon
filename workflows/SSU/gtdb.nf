...
workflow MAKE_GTDB_CLASSIFIERS {
    ...
    FULL_CULL_GTDB(FULL_DEREP_GTDB.out.derep_seqs)
    FULL_TRAIN_GTDB(FULL_CULL_GTDB.out.culled_seqs, FULL_DEREP_GTDB.out.derep_taxa)
    ...
    AMP_CULL_GTDB(AMP_DEREP_GTDB.out.derep_seqs)
    AMP_TRAIN_GTDB(AMP_CULL_GTDB.out.culled_seqs, AMP_DEREP_GTDB.out.derep_taxa)
}
